...
//=========preloader========================
      ...
      document.addEventListener('click', function(event) {
        ...
        if (event.target.matches('.list > li > svg:nth-child(1)')) {
            var nextUl = event.target.nextElementSibling;
            if (nextUl && nextUl.tagName.toLowerCase() === 'svg') {
              // Toggle the visibility of the next <ul>
          ...
          } else if (event.target.matches('.list > li > svg:nth-child(2)')) {
            var nextUl = event.target;
      ...
      am4core.useTheme(am4themes_animated);
        ...
        countriesSeries.geodata = am4geodata_continentsLow;
